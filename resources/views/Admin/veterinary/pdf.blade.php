...
<body>
    ...
    <table>
        ...
        <tbody>
            @forelse ($veterinaries as $vet)
                <tr>
                    <td class="text-center">#{{ $vet->id }}</td>
                    <td>{{ $vet->employee->nombres ?? '—' }} {{ $vet->employee->apellidos ?? '' }}</td>
                    <td>{{ $vet->employee->dni ?? '—' }}</td>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center" style="padding: 20px;">
                        <em>No hay veterinarios registrados.</em>
                    </td>
                </tr>
            @endforelse
        </tbody>
